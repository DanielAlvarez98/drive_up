<div class="modal fade text-left" id="editVehModal" tabindex="-1" aria-labelledby="myModalLabel1" style="display: none;"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel1">Editar Documento</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="dempresa" class="form-control empresa" name="empresa"
                                        placeholder="Empresa">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-select" id="" name="car_id" required>
                            ...
                            <div class="col-12">
                                <input type="file" id="imagenEditCar" name="imagen">
                            </div>
                        </div>
